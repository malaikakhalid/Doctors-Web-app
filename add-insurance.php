...
if(isset($_POST['save']))
{
  ...
  $query="insert into insurance(insurance_name) values('".$insurance."')";
...
if(isset($_POST['submit']))
{
  ...
  $query="insert into insurance(insurance_name) values('".$insurance_name."')";
  $test=mysqli_query($conn,$query);
  if($test) 
  {
    header('Location:add-insurance.php');
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="form-group">
                                    <!-- <div class="form-group">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="country_name">
                                    ...
                                    <label for="exampleInputPassword1">Add Insurance</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="txtinsurance">
                                </div>
                                <button type="submit" class="btn btn-primary" style="float: right;"
                            ...
                            <table class="card-table table">
                                ...
                                <tbody>
                                    <?php
                                                ...
                                                echo "<td><a href='insurance_update.php?id=".$row['insurance_id']."' class='btn btn-primary'>Update</a></td>";
  		                                        echo "<td><a href='insurance_delete.php?id=".$row['insurance_id']."' class='btn btn-danger'>Delete</a> </td>";
  	                                        	echo "</tr>";
                                             	}
                                       ?>
                                        ...
                                        <div class="modal-dialog" role="document" style="padding-top:180px">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="d_update" method="POST">
                                                        <div class="form-group">
