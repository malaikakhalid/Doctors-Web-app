...
if(isset($_POST['save']))
{
  $country=$_POST['txtcount'];
  

  $query="insert into specialty(specialty_name) values('".$country."')";
                        ...
                        <div class="card" style="padding:20px">
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="exampleInputPassword1">Enter Specialty</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="txtcount">
                                </div>
                            ...
                            <table class="card-table table">
                                ...
                                <tbody>
                                    <?php
                                                ...
                                                echo "<td><a href='specialty_update.php?id=".$row['specality_id']."' class='btn btn-primary'>Update</a></td>";
  		                                        echo "<td><a href='D_delete.php?id=".$row['specality_id']."' class='btn btn-danger'>Delete</a> </td>";
  	                                        	echo "</tr>";
                                             	}
                                       ?>
